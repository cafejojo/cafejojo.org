        ...
        <div className="mt-16">
            ...
            <div className="content-section bg-delft-blue text-white">
                ...
                <div className="my-2 text-center text-xl">
                    <a className="btn btn-green inline-block" href="https://repository.tudelft.nl/islandora/object/uuid:cca5e4ea-3d00-4ae3-877a-b302829e7f08?collection=education">
